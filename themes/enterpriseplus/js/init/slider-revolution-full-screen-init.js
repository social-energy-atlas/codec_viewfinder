jQuery(document).ready(function($) {
  if (drupalSettings.enterpriseplus.sliderRevolutionFullScreenInit.slideshowFullScreenNavigationStyle == "bullets") {
  ...
  if ($(".transparent-header-active").length>0) {
    jQuery(".slideshow-fullscreen .slider-revolution").revolution({
      ...
      delay: drupalSettings.enterpriseplus.sliderRevolutionFullScreenInit.slideshowFullScreenEffectTime,
      ...
      navigation: {
        ...
        bullets:{
          ...
          space: 5,
          h_align:  drupalSettings.enterpriseplus.sliderRevolutionFullScreenInit.slideshowFullScreenBulletsPosition,
          v_align:"bottom",
          h_offset: 0,
          v_offset: 20,
          tmp:"",
        ...
        touch:{
          touchenabled: drupalSettings.enterpriseplus.sliderRevolutionFullScreenInit.slideshowFullScreenTouchSwipe,
          swipe_treshold:75,
          swipe_min_touches:1,
